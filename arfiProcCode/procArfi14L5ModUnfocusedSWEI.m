function procArfi14L5ModUnfocusedSWEI(fname, parFile, interpFactor, kernelLength, ccmode, ref_idx)
...
par.priusec([1 3]) =par.priusec([1 3]).*2;
par.ntrack=[par.ntrack(1)/2 par.ntrack(2)];  %divide ntrack by 2 because it doesn't take into account alternating focused unfocused
